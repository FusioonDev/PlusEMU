    ...
    public class CatalogIndexComposer : MessageComposer
    {
        ...
        public override void Compose(ServerPacket packet)
        {
            ...
            foreach (CatalogPage parent in Pages)
            {
                ...
                if (parent.ParentId != -1 || parent.MinimumRank > Habbo.Rank)
                    continue;
                ...
                foreach (CatalogPage child in Pages)
                {
                    ...
                    if (child.ParentId != parent.Id || child.MinimumRank > Habbo.Rank)
                        continue;
