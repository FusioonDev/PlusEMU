    ...
    internal class InfoCommand : IChatCommand
    {
        ...
        public void Execute(GameClient session, Room room, string[] @params)
        {
            ...
            session.SendPacket(new RoomNotificationComposer("",
                "Powered with PlusEmulator R4\n\n" +
                "<b>Credits</b>:\n" +
                "Fusion (current maintainer)\n" +
                "Sledmore & Plus Developers\n" +
                "Joopie for encryption\n" +
                "Butterfly Emulator Developers for the base\n\n" +
                ...
                //"<b>SWF Revision</b>:\n" + PlusEnvironment.ClientRevision,
                "plus", ""));
        }
    }
}